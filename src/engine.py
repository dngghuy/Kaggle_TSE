...
def train_fn(data_loader, model, optimizer, device, scheduler=None, wandb_notes=None):
    model.train()
        ...
        wandb.log(
            {
                ...
                'train_jaccards': float(jaccards.avg)
            }
        )
    else:
        wandb.log(
            {
                f'{wandb_notes}_train_loss': float(losses.avg),
                f'{wandb_notes}_train_jaccards': float(jaccards.avg)
            }
        )
